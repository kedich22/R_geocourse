...
plot_directions(c(baikal$cdir, baikal$cdir + 180), 'Направление активных разломов', 'Байкальская рифтовая зона')
plot_directions(c(caucasus$cdir, caucasus$cdir + 180), 'Направление активных разломов', 'Кавказ')
```
